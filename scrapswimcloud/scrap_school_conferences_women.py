...
def scrape_teams_list(driver, base_url, max_pages=None):
    ...
    print("\n" + "="*80)
    print("SCRAPING DIVISION 1 WOMEN'S TEAMS LIST")
    print("="*80)
...
def main():
    print("\n" + "="*80)
    print("SCHOOL CONFERENCES SCRAPER - WOMEN'S TEAMS")
    print("="*80)

    # CONFIGURATION - Changed gender to F for women's teams
    TEAMS_URL = "https://www.swimcloud.com/country/usa/teams/?eventCourse=Y&gender=F&page=1&rankType=D&region=division_1&seasonId=29&sortBy=all"
    ...
    try:
        ...
        output_file = "schools_conferences_women.csv"
    ...
    print("ALL DONE! 🏊‍♀️")
    print("="*80)
    print(f"\nYour data is ready in: schools_conferences_women.csv")
    print("="*80 + "\n")
